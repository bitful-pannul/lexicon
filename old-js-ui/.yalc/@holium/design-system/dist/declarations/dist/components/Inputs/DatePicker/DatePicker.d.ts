...
export declare const DatePicker: ({ startDate, endDate, minBookingDate, maxBookingDate, focusedInput, onDatesChange, dayLabelFormat, weekdayLabelFormat, monthLabelFormat, initialVisibleMonth, vertical, rtl, showResetDates, exactMinBookingDays, isDateBlocked, minBookingDays, numberOfMonths: numberOfMonthsProp, firstDayOfWeek: firstDayOfWeekProp, unavailableDates, }: DatepickerProps, ref?: React.Ref<unknown>) => JSX.Element;
