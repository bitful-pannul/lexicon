...
import { compose, space as space$1, color, layout, flexbox, border, position, grid, typography, variant, overflow, height, size, background } from 'styled-system';
import * as React from 'react';
import React__default, { forwardRef, useState, useRef, useContext, useImperativeHandle, isValidElement, useCallback, useEffect, useMemo } from 'react';
import { rgba, darken, lighten } from 'polished';
import { useDay, useMonth, useDatepicker, dayLabelFormat, weekdayLabelFormat, monthLabelFormat, START_DATE } from '@datepicker-react/hooks';
...
}, compose(space$1, color, layout, flexbox, border, position));
...
}, compose(space$1, layout, flexbox, position));
Flex.defaultProps = {
  gap: 0
};
...
function makeMedia(media) {
  // css();
  return function () {
    return css(["@media ", "{", "}"], media, // @ts-expect-error
...
var Column = styled(styled.div.withConfig({
  displayName: "Column",
  ...
  return !p.noGutter && css(["", ""], DIMENSIONS.map(function (d) {
  ...
  return css(["", ""], DIMENSIONS.map(function (d) {
  ...
  return p.offset && css(["", ""], DIMENSIONS.map(function (d) {
  ...
  return p.order !== undefined && css(["", ""], DIMENSIONS.map(function (d) {
  ...
  return p.reverse && css(["", ""], Array.isArray(p.reverse) ? DIMENSIONS.map(function (d) {
  ...
  return p.align && css(["", ""], _typeof(p.align) === 'object' ? DIMENSIONS.map(function (d) {
  ...
  return p.justify && css(["", ""], _typeof(p.justify) === 'object' ? DIMENSIONS.map(function (d) {
  ...
  return debug && css(["background-color:#5901ad40;outline:#fff solid 1px;"]);
})).withConfig({
  displayName: "Column",
  componentId: "sc-1etip5k-0"
})(compose(layout, space$1));
...
var Container$1 = styled(styled.div.withConfig({
  ...
  return !p.fluid && css(["", ""], DIMENSIONS.map(function (d) {
...
var typographyFunctions = compose(space$1, color, layout, flexbox, border, position, typography);
...
var Text = styled.p.withConfig({
  ...
  return props.fontByName && css(["font-family:", ";"], props.theme.fontByName[props.fontByName]);
}, function (props) {
  return props.fontByType && css(["font-family:", ";"], props.theme.fonts[props.fontByType]);
});
Text.defaultProps = {
  variant: 'inherit'
};
...
var SvgComponent$U = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  ...
  }, props), title ? /*#__PURE__*/React__default.createElement("title", {
    id: titleId
  }, title) : null, /*#__PURE__*/React__default.createElement("path", {
    d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"
  }));
});
var SvgCheckCircle = styled(SvgComponent$U).withConfig({
  displayName: "check-circle__SvgCheckCircle",
  componentId: "sc-1x4nyub-0"
})({
  flex: 'none',
  verticalAlign: 'middle'
}, compose(space$1, color, layout, typography));

var _excluded$11 = ["title"];
var SvgComponent$T = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgCheckboxBlank = styled(SvgComponent$T).withConfig({
...
var SvgComponent$S = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgCheckboxChecked = styled(SvgComponent$S).withConfig({
...
var _excluded$$ = ["title"];
var SvgComponent$R = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgCheckboxIndeterminate = styled(SvgComponent$R).withConfig({
...
var SvgComponent$Q = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgClose = styled(SvgComponent$Q).withConfig({
...
var SvgComponent$P = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgApps = styled(SvgComponent$P).withConfig({
...
var SvgComponent$O = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgError = styled(SvgComponent$O).withConfig({
...
var SvgComponent$N = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgExpandMore = styled(SvgComponent$N).withConfig({
...
var SvgComponent$M = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgInfo = styled(SvgComponent$M).withConfig({
...
var SvgComponent$L = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgLoader = styled(SvgComponent$L).withConfig({
...
var SvgComponent$K = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgPlace = styled(SvgComponent$K).withConfig({
...
var SvgComponent$J = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgRadioChecked = styled(SvgComponent$J).withConfig({
...
var SvgComponent$I = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgRadioUnchecked = styled(SvgComponent$I).withConfig({
...
var SvgComponent$H = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgSearch = styled(SvgComponent$H).withConfig({
...
var SvgComponent$G = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgVisibility = styled(SvgComponent$G).withConfig({
...
var SvgComponent$F = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgVisibilityOff$q = styled(SvgComponent$F).withConfig({
...
var SvgAddUser$5 = styled(SvgComponent$E).withConfig({
...
var SvgVisibilityOff$p = styled(SvgComponent$D).withConfig({
...
var SvgVisibilityOff$o = styled(SvgComponent$C).withConfig({
...
var SvgVisibilityOff$n = styled(SvgComponent$B).withConfig({
...
var SvgVisibilityOff$m = styled(SvgComponent$A).withConfig({
...
var SvgComponent$z = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgVisibilityOff$l = styled(SvgComponent$z).withConfig({
...
var SvgComponent$y = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgVisibilityOff$k = styled(SvgComponent$y).withConfig({
...
var SvgComponent$x = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgVisibilityOff$j = styled(SvgComponent$x).withConfig({
...
var SvgComponent$w = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var SvgVisibilityOff$i = styled(SvgComponent$w).withConfig({
...
var SvgComponent$v = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  var title = _ref.title,
...
var Svg$7 = styled(SvgComponent$v).withConfig({
...
var Svg$6 = styled(SvgComponent$u).withConfig({
...
var SvgVisibilityOff$h = styled(SvgComponent$t).withConfig({
...
var SvgVisibilityOff$g = styled(SvgComponent$s).withConfig({
...
var SvgVisibilityOff$f = styled(SvgComponent$r).withConfig({
...
var SvgVisibilityOff$e = styled(SvgComponent$q).withConfig({
...
var SvgVisibilityOff$d = styled(SvgComponent$p).withConfig({
...
var SvgVisibilityOff$c = styled(SvgComponent$o).withConfig({
...
var SvgVisibilityOff$b = styled(SvgComponent$n).withConfig({
...
var SvgVisibilityOff$a = styled(SvgComponent$m).withConfig({
...
var SvgVisibilityOff$9 = styled(SvgComponent$l).withConfig({
...
var SvgVisibilityOff$8 = styled(SvgComponent$k).withConfig({
...
var SvgVisibilityOff$7 = styled(SvgComponent$j).withConfig({
...
var SvgVisibilityOff$6 = styled(SvgComponent$i).withConfig({
...
var SvgAddUser$4 = styled(SvgComponent$h).withConfig({
...
var SvgVisibilityOff$5 = styled(SvgComponent$g).withConfig({
...
var SvgVisibilityOff$4 = styled(SvgComponent$f).withConfig({
...
var SvgVisibilityOff$3 = styled(SvgComponent$e).withConfig({
...
var SvgEle = styled(SvgComponent$d).withConfig({
...
var Svg$5 = styled(SvgComponent$c).withConfig({
...
var Svg$4 = styled(SvgComponent$b).withConfig({
...
var Svg$3 = styled(SvgComponent$a).withConfig({
...
var Svg$2 = styled(SvgComponent$9).withConfig({
...
var Svg$1 = styled(SvgComponent$8).withConfig({
...
var Svg = styled(SvgComponent$7).withConfig({
...
var SvgAddUser$3 = styled(SvgComponent$6).withConfig({
...
var SvgAddUser$2 = styled(SvgComponent$5).withConfig({
...
var SvgAddUser$1 = styled(SvgComponent$4).withConfig({
...
var SvgAddUser = styled(SvgComponent$3).withConfig({
...
var SvgVisibilityOff$2 = styled(SvgComponent$2).withConfig({
...
var SvgComponent$1 = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  ...
  return /*#__PURE__*/React__default.createElement("svg", _extends({
    ...
    id: titleId
  }, title) : null, /*#__PURE__*/React__default.createElement("g", null, /*#__PURE__*/React__default.createElement("path", {
...
var SvgVisibilityOff$1 = styled(SvgComponent$1).withConfig({
...
var Blank = function Blank() {
  return /*#__PURE__*/React.createElement("path", null);
};
...
var SvgComponent = /*#__PURE__*/forwardRef(function (_ref, svgRef) {
  ...
  return /*#__PURE__*/React__default.createElement("svg", _extends({
    ...
    id: titleId
  }, title) : null, /*#__PURE__*/React__default.createElement(InnerIcon, null));
});
var SvgVisibilityOff = styled(SvgComponent).withConfig({
...
var focusBorder = css(["transition:0.2s ease;border:1px solid ", ";outline:none;"], function (props) {
  return props.theme.colors.brand.primary;
});
var focusRing = css(["transition:0.2s ease;outline:1px solid ", ";"], function (props) {
  return props.theme.colors.brand.primary;
});
var selectableFocus = css(["&:focus{", "}&:active{outline:none !important;}"], focusRing);
var Divider = styled.hr.withConfig({
  ...
  return rgba(props.theme.colors.ui.borderColor, 0.5);
}, compose(space$1));

var _excluded$9 = ["children", "label", "disabled", "error", "mb", "mt", "mx", "my", "ml", "mr"];
var checkboxIconStyles = css(["color:", ";font-size:", "px;margin-right:", "px;&:hover{color:", ";}input:focus ~ &{color:", ";}input:checked:disabled ~ &,input:disabled ~ &{color:", ";}input:checked ~ &{color:", ";}"], function (props) {
...
var CheckboxUnchecked = styled(Icons.CheckboxChecked).withConfig({
...
var CheckboxChecked = styled(Icons.CheckboxBlank).withConfig({
...
var CheckboxIcon = function CheckboxIcon(props) {
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(CheckboxUnchecked, props), /*#__PURE__*/React__default.createElement(CheckboxChecked, props));
};
...
var Field = styled(Grid).attrs({
  ...
  return props.inline && css(["grid-gap:", "px;grid-template-columns:2fr 4fr;"], props.theme.space[4]);
});
Field.defaultProps = {
  border: 0,
  p: 0,
...
var FieldSet = styled(Grid).attrs({
  gridGap: 2,
  as: 'fieldset'
}).withConfig({
...
var InputWrapper = styled(Flex).withConfig({
  ...
  return props.borderColor && css(["border-color:", ";&:hover{border-color:", ";}&:read-only{border-color:", ";}&:-moz-read-only{border-color:", ";}&:focus{border-color:", ";}"], props.borderColor, props.borderColor, props.borderColor, props.borderColor, props.borderColor);
});
...
var ContentArea$3 = styled(Text).withConfig({
  ...
  return props.theme.colors.text.disabled;
}, compose(space$1, layout, flexbox, border, position, color));
...
var LeftIcon$2 = styled(Box).withConfig({
  ...
  return props.interactive && css(["pointer-events:none;user-select:none;"]);
}, function (props) {
  return props.theme.fontSizes[3];
}, function (props) {
  return props.disabled ? props.theme.colors.text.disabled : props.theme.colors.text.primary;
});
var RightIcon$2 = styled(Box).withConfig({
...
var Input = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React__default.createElement(InputWrapper, {
    ...
    flex: flex,
    style: props.style
  }, leftIcon && /*#__PURE__*/React__default.createElement(LeftIcon$2, {
    style: {
      pointerEvents: leftInteractive ? 'auto' : 'none'
    },
    mr: inputTokens$1.x,
    disabled: disabled
  }, leftIcon), /*#__PURE__*/React__default.createElement(ContentArea$3, _extends({
    as: "input",
    variant: variant,
    ref: ref,
  ...
  })), rightIcon && /*#__PURE__*/React__default.createElement(RightIcon$2, {
    style: {
...
var Label = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React__default.createElement(StyledLabel, _extends({
    ...
    ref: ref,
    color: "text.primary"
  }, props), children, props.adornment && /*#__PURE__*/React__default.createElement(Box, {
    display: "inline-flex",
    alignItems: "center",
    color: "text.secondary",
    ml: 1
...
var radioIconStyles = css(["color:", ";font-size:", "px;margin-right:", "px;&:hover{color:", ";}input:focus ~ &{outline:none;color:", ";}input:checked:disabled ~ &,input:disabled ~ &{color:", ";}input:checked ~ &{color:", ";}"], function (props) {
  return props.error ? props.theme.colors.ui.intent.alert : props.theme.colors.ui.secondary;
}, function (props) {
...
var RadioIcon = function RadioIcon(props) {
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(RadioUnchecked, props), /*#__PURE__*/React__default.createElement(RadioChecked, props));
};
...
var ContentArea$2 = styled(Text).withConfig({
...
var LeftIcon$1 = styled(Box).withConfig({
...
var RightIcon$1 = styled(Box).withConfig({
...
var HTMLSelect = /*#__PURE__*/forwardRef(function (_ref, ref) {
  var leftIcon = _ref.leftIcon,
      rightIcon = _ref.rightIcon,
      mb = _ref.mb,
      mt = _ref.mt,
  ...
  return /*#__PURE__*/React__default.createElement(Flex, {
    ...
    ml: ml,
    mr: mr
  }, leftIcon && /*#__PURE__*/React__default.createElement(LeftIcon$1, {
    left: selectTokens.x,
    disabled: disabled
  }, leftIcon), /*#__PURE__*/React__default.createElement(ContentArea$2, _extends({
    as: "select",
    variant: "body",
    ref: ref,
    py: 2,
    ...
    disabled: disabled,
    "aria-invalid": props.error ? 'true' : 'false'
  }, props)), rightIcon && /*#__PURE__*/React__default.createElement(RightIcon$1, {
    right: selectTokens.iconRightOffset,
    disabled: disabled
  }, rightIcon), /*#__PURE__*/React__default.createElement(RightIcon$1, {
    right: selectTokens.x,
    disabled: disabled
  }, /*#__PURE__*/React__default.createElement(Icons.ExpandMore, {
    color: "text.primary",
    "aria-hidden": true
  })));
});
...
var ContentArea$1 = styled(Text).withConfig({
...
var TextArea = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Box, {
    ...
    ml: ml,
    mr: mr
  }, /*#__PURE__*/React__default.createElement(ContentArea$1, _extends({
    as: "textarea",
    variant: "body",
    mb: 0,
    ref: ref,
  ...
  }, props)), maxCharacters ? /*#__PURE__*/React__default.createElement(Text, {
    variant: "hint",
    width: "100%",
...
styled(styled.div.withConfig({
  ...
  return props.large ? css(["padding:5px 7px 5px 2px;background:transparent;border:1px solid transparent;transition:", ";&:hover{transition:", ";background:", ";}outline:transparent;"], function (props) {
    return props.theme.transition;
  }, function (props) {
    return props.theme.transition;
  }, function (props) {
    return props.theme.colors.highlights.bgHighlight;
  }) : css(["font-size:", ";padding:4px 8px;background:", ";border:1px solid ", ";transition:", ";&:focus{", "}", ""], function (props) {
    return props.theme.fontSizes[2];
  }, function (props) {
    ...
    return props.theme.transition;
  }, focusRing, !props.isOpen ? css(["&:hover{transition:", ";border-color:", ";}"], function (props) {
    return props.theme.transition;
  }, function (props) {
    return props.theme.colors.ui.input.borderHover;
  }) : css(["transition:", ";border-color:", ";"], function (props) {
    return props.theme.transition;
  }, function (props) {
    return props.theme.colors.brand.primary;
  }));
}, function (props) {
  return props.small && css(["padding:2px 8px 2px 8px;min-width:60px;"]);
}, function (props) {
  return props.gray && css(["background:", ";"], function (props) {
    return props.theme.colors.bg.primary;
  });
})).withConfig({
  displayName: "Selectstyles__SelectRow",
  componentId: "sc-3e27x3-1"
})({}, compose(space$1, color, typography));
styled(styled.div.withConfig({
...
var Select = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  return /*#__PURE__*/React__default.createElement(SelectWrapper, {
    ...
    rightInteractive: false,
    rightIcon: /*#__PURE__*/React__default.createElement(Icons.ArrowDropdown, {
      size: 2,
      style: {
        opacity: 0.5
      },
  ...
  }, props)), /*#__PURE__*/React__default.createElement(Menu, {
    id: id,
    key: id,
    style: {
...
var ContentArea = styled(Text).withConfig({
  ...
  return darken(0.05, props.theme.colors.ui.tertiary);
}, function (props) {
...
var LeftIcon = styled(Box).withConfig({
...
var RightIcon = styled(Box).withConfig({
...
var InlineEdit = /*#__PURE__*/forwardRef(function (_ref, ref) {
  var leftIcon = _ref.leftIcon,
      rightIcon = _ref.rightIcon,
      flex = _ref.flex,
      mb = _ref.mb,
  ...
  if (!ref) ref = /*#__PURE__*/React__default.createRef();
  ...
  return /*#__PURE__*/React__default.createElement(Flex, {
    ...
    left: inputTokens.x,
    disabled: disabled
  }, leftIcon), /*#__PURE__*/React__default.createElement(ContentArea, _extends({
    as: "input",
    variant: "body",
    ref: ref,
    py: 2,
  ...
  }, props)), rightIcon && /*#__PURE__*/React__default.createElement(RightIcon, {
    right: inputTokens.x,
    disabled: disabled
  }, rightIcon));
});
...
var Month = function Month(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Flex, {
    ...
    variant: "h6",
    fontWeight: "500"
  }, monthLabel)), /*#__PURE__*/React__default.createElement(Grid, {
...
var composeMonthGridStyles$1 = compose(overflow, height);
var MonthGrid$1 = styled(Grid).withConfig({
...
var DatePicker = function DatePicker(_ref, ref) {
  var startDate = _ref.startDate,
      ...
      dayLabelFormat$1 = _ref.dayLabelFormat,
      weekdayLabelFormat$1 = _ref.weekdayLabelFormat,
      monthLabelFormat$1 = _ref.monthLabelFormat,
  ...
  return /*#__PURE__*/React__default.createElement(DatepickerContext.Provider, {
    value: {
      focusedDate: focusedDate,
      // @ts-ignore
      isDateFocused: isDateFocused,
    ...
    flexDirection: "column"
  }, /*#__PURE__*/React__default.createElement(MonthGrid$1, {
    ...
    return /*#__PURE__*/React__default.createElement(Month, {
      key: "month-".concat(month.year, "-").concat(month.month),
      year: month.year,
      month: month.month,
      firstDayOfWeek: firstDayOfWeek // @ts-ignore
      ,
      dayLabelFormat: dayLabelFormat$1 || dayLabelFormat,
      weekdayLabelFormat: weekdayLabelFormat$1 || weekdayLabelFormat,
      monthLabelFormat: monthLabelFormat$1 || monthLabelFormat
    });
  })), showResetDates && /*#__PURE__*/React__default.createElement(Flex, {
    flex: "1",
    justifyContent: "flex-end",
    m: "2px 8px"
  }, /*#__PURE__*/React__default.createElement(TextButton, {
    onClick: onResetDates
  }, "Reset"))), /*#__PURE__*/React__default.createElement(Flex, {
    alignItems: "center"
  }, /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Box, {
    position: "absolute",
    top: "4px",
    left: "8px",
    right: "unset",
  ...
  }, /*#__PURE__*/React__default.createElement(Icons.AngleLeft, null))), /*#__PURE__*/React__default.createElement(Box, {
    position: "absolute",
    top: "4px",
    left: "unset",
    right: "8px",
  ...
  }, /*#__PURE__*/React__default.createElement(Icons.AngleRight, null)))))));
};
var DatePicker$1 = /*#__PURE__*/React__default.forwardRef(DatePicker);
...
var DateSingleInput = function DateSingleInput(_ref) {
  ...
  var ref = useRef(null);
  var show, setShow;
  var dateInputRef = React__default.useRef(null);
  ...
  return /*#__PURE__*/React__default.createElement(Box, {
    ...
    ref: dateInputRef,
    tabIndex: tabIndex,
    leftIcon: /*#__PURE__*/React__default.createElement(Icons.Calendar, {
      style: {
        opacity: 0.5
      }
    }),
...
var TimeInputBox = styled.form.withConfig({
...
var TimeInput = function TimeInput(_ref) {
  ...
  var hrRef = /*#__PURE__*/React__default.createRef();
  var minRef = /*#__PURE__*/React__default.createRef();
  var secRef = /*#__PURE__*/React__default.createRef();
  var amPmRef = /*#__PURE__*/React__default.createRef();
  ...
  return /*#__PURE__*/React__default.createElement(TimeInputBox, {
    px: "12px",
    mt: 1,
    mb: 2,
    gap: "4px",
    ...
    onKeyPress: handleKeyPress
  }), showSeconds && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, ":", /*#__PURE__*/React__default.createElement(Input, {
    ref: secRef,
    required: true,
    name: "seconds",
    bg: "transparent",
    ...
    onKeyPress: handleKeyPress
  })), !is24 && /*#__PURE__*/React__default.createElement(HTMLSelect, {
    ref: amPmRef,
    name: "amPm",
    ml: "8px",
    style: {
    ...
    value: "AM"
  }, "AM"), /*#__PURE__*/React__default.createElement("option", {
    value: "PM"
  }, "PM"))); // }, [timeObj]);
};

var composeMonthGridStyles = compose(overflow, height);
var MonthGrid = styled(Grid).withConfig({
...
var DateTimePicker = function DateTimePicker(_ref, ref) {
  ...
  return /*#__PURE__*/React__default.createElement(DatepickerContext.Provider, {
    ...
    flexDirection: "column"
  }, /*#__PURE__*/React__default.createElement(MonthGrid, {
    "data-testid": "MonthGrid",
    overflow: "auto",
    gridTemplateColumns: vertical ? '1fr' : "repeat(".concat(numberOfMonths, ", 1fr)"),
    gridGap: "0 32px",
    ...
    my: "8px"
  }), /*#__PURE__*/React__default.createElement(TimeInput, {
    is24: false,
    showSeconds: false,
    date: startDate,
...
var DateTimePicker$1 = /*#__PURE__*/React__default.forwardRef(DateTimePicker);
...
var DateTimeInput = function DateTimeInput(_ref) {
  ...
  }, /*#__PURE__*/React__default.createElement(DateTimePicker$1, {
    ref: ref,
    exactMinBookingDays: true,
    minBookingDays: 1,
    onClose: handleDatepickerClose,
...
var NotificationStyle = styled(styled.div.withConfig({
  ...
  return props.hasBorder ? "1px solid ".concat(rgba(props.customColor, 0.5)) : 'none';
}, function (props) {
  return props.theme.fontWeights.light;
}, function (props) {
  return rgba(props.customColor, 0.2);
}, function (props) {
...
var Notification = function Notification(props) {
  return /*#__PURE__*/React.createElement(NotificationStyle, {
...
var Group = function Group(props) {
  return /*#__PURE__*/React.createElement(Flex, {
    ...
    padding: [4, 0, 4, 0],
    flexDirection: "row"
  }, props.sigil && /*#__PURE__*/React.createElement(Sigil, {
  ...
  }, props.name), props.link && /*#__PURE__*/React.createElement(Text, {
    style: {
      opacity: 0.75
    },
    variant: "body",
    fontByType: "monospace"
  }, props.link), props.participantNumber && /*#__PURE__*/React.createElement(Text, {
    style: {
      opacity: 0.5
    },
    variant: "body",
    fontByType: "monospace"
  }, "".concat(props.participantNumber, " ").concat(props.participantType))), props.notification && /*#__PURE__*/React.createElement(Notification, {
    colour: props.customColour
  }, props.notification), props.type && /*#__PURE__*/React.createElement(Tag, {
    label: props.entity,
    minimal: true,
...
var AvatarWrapper = styled(styled.div.withConfig({
  ...
  return props.clickable && css(["cursor:pointer;"]);
})).withConfig({
  displayName: "Sigilstyles__AvatarWrapper",
  componentId: "sc-t5ic5o-0"
})(compose(space$1, layout, flexbox, border, position, color));
var SigilStyle = styled(styled.div.withConfig({
...
var Sigil = function Sigil(props) {
  ...
  if (avatar) {
    element = /*#__PURE__*/React.createElement(AvatarWrapper, {
      id: "ship",
    ...
    element = /*#__PURE__*/React.createElement(SigilStyle, {
      id: "ship",
      tabIndex: clickable ? 0 : -1,
      ref: sigilRef,
      clickable: clickable,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, element, /*#__PURE__*/React.createElement(Menu, {
...
var SimpleSpinner = styled.div.withConfig({
  ...
  return rgba(props.theme.colors.ui.secondary, 0.2);
}, function (props) {
  return props.theme.colors.brand.secondary;
});
var SimpleSpinnerComposed = styled(SimpleSpinner).withConfig({
...
var Spinner = /*#__PURE__*/React__default.memo(function () {
  ...
  }, props), /*#__PURE__*/React__default.createElement(SimpleSpinnerComposed, {
    title: title,
    size: sizes$1[size],
    color: color
  }));
...
var TabStyle = styled.div.withConfig({
  ...
  return rgba(p.theme.colors.text.disabled, 0.7);
}, function (p) {
  return p.theme.colors.text.disabled;
}, function (p) {
  return p.isActive && css(["border-bottom:", "px solid ", ";pointer-events:none;color:", ";:hover{border-bottom:", "px solid ", ";}"], underlineSize, function (p) {
  ...
  return p.isDisabled && css(["pointer-events:none;opacity:0.3;"]);
});
...
var Tab = function Tab(props) {
  ...
  return /*#__PURE__*/React.createElement(TabStyle, {
...
var ColorLine = styled(styled.div.withConfig({
...
var CardInner = styled(styled.div.withConfig({
...
var Card = styled(styled.div.withConfig({
  displayName: "Card",
  ...
  return props.selectable && css(["transition:", ";cursor:pointer;&:hover{transition:", ";border-color:", ";}"], function (props) {
    return props.theme.transition;
  }, function (props) {
    return props.theme.transition;
  }, function (props) {
...
var margin = 2;
var placementMaps = {
  bottom: css(["margin-top:", "px;top:100%;left:50%;transform:translate(-50%,0);"], margin),
  'bottom-right': css(["top:100%;left:100%;"]),
  'bottom-left': css(["top:100%;right:100%;"]),
  top: css(["margin-bottom:", "px;bottom:100%;left:50%;transform:translate(-50%,0);"], margin),
  'top-right': css(["bottom:100%;left:100%;"]),
  'top-left': css(["bottom:100%;right:100%;"]),
  left: css(["margin-right:", "px;bottom:50%;right:100%;transform:translate(0,50%);"], margin),
  right: css(["margin-left:", "px;bottom:50%;left:100%;transform:translate(0,50%);"], margin)
}; // Tooltip

var TooltipStyle = styled(styled.div.withConfig({
...
})(compose(space$1, color, typography)); // Parent wrapper

var TooltipWrapper = styled(styled.div.withConfig({
...
var TextButton = styled(styled.button.withConfig({
  ...
  return css(["font-size:", ";color:", ";transition:.1s;:hover{transition:.1s background-color:", ";}:active{background-color:", ";}:disabled{pointer-events:none;opacity:.5;}"], props.fontSize ? "".concat(props.fontSize, "px") : '14px', props.highlightColor || props.theme.colors.brand.primary, props.highlightColor ? "".concat(props.highlightColor, "25") : "".concat(props.theme.colors.brand.primary, "25"), props.highlightColor ? "".concat(props.highlightColor, "30") : "".concat(props.theme.colors.brand.primary, "30"));
})).withConfig({
  displayName: "TextButton",
...
var IconButton = styled(styled.button.withConfig({
  ...
  return props.color || rgba(props.theme.colors.icon.app, 0.5);
}, function (props) {
  ...
  return props.hoverReveal ? css(["opacity:0;transition:0.2s ease;padding:3px;background:transparent;&:hover{opacity:1;background:", ";}"], function (props) {
    return props.theme.colors.highlights.bgHighlight;
  }) : css(["transition:0.2s ease;&:hover{background:", ";svg{fill:", ";}}"], function (props) {
    return props.theme.colors.highlights.bgHighlight;
  }, function (props) {
    return props.color || rgba(props.theme.colors.icon.app, 0.7);
  });
}, selectableFocus, function (props) {
  return props.theme.colors.ui.disabled;
}, function (props) {
  ...
  cursor: 'pointer'
}, compose(space$1, size, color, layout, typography));
...
})(["&:focus{}", " ", ""], buttonVariants, compose(space$1, layout, color, background, flexbox, border, position));
// TODO add sizes
var Button = /*#__PURE__*/forwardRef(function (_ref, ref) {
  ...
  }, leftIcon && /*#__PURE__*/React__default.createElement(IconButton, {
    disabled: disabled,
    mr: 2
  }, leftIcon), children, rightIcon && /*#__PURE__*/React__default.createElement(IconButton, {
    disabled: disabled,
    ml: 2
  }, rightIcon)));
});
...
var ResultList = styled(styled.div.withConfig({
...
var SearchResultList = /*#__PURE__*/React__default.memo(function (_ref) {
  var results = _ref.results;
  // api call to results
  // mocked for now
  var hasResults = results.length;
  return /*#__PURE__*/React__default.createElement(ResultList, null, !hasResults ? /*#__PURE__*/React__default.createElement("div", {
    className: "no-suggestions"
  }, /*#__PURE__*/React__default.createElement("span", {
    role: "img",
    "aria-label": "tear emoji"
  }, "\uD83D\uDE2A"), ' ', /*#__PURE__*/React__default.createElement("em", null, "sorry no suggestions")) : results.map(function (result, index) {
    return /*#__PURE__*/React__default.createElement("div", {
      key: "".concat(index)
...
var Search = function Search() {
  ...
  var _useState5 = useState(mockResults),
  ...
  return /*#__PURE__*/React__default.createElement(SearchWrapper, null, /*#__PURE__*/React__default.createElement(Input, {
    name: "topbar-search",
    spellCheck: false,
    borderRadius: 30,
    autoComplete: "off",
    ...
    value: searchQuery,
    placeholder: "Search...",
    leftIcon: /*#__PURE__*/React__default.createElement(Icons.Search, {
      "aria-hidden": true
    })
  }), searchQuery && /*#__PURE__*/React__default.createElement(Menu, {
    style: {
      top: '100%',
      padding: '8px 12px',
      width: 'calc(100% - 20px)',
  ...
  }, !showSuggestions && /*#__PURE__*/React__default.createElement(Flex, {
    justifyContent: "center",
    alignItems: "center"
  }, /*#__PURE__*/React__default.createElement(Spinner, {
    size: 2
  })), showSuggestions && /*#__PURE__*/React__default.createElement(SearchResultList, {
...
var GenericRow = styled.div.withConfig({
...
var ListHeaderStyle = styled(styled.div.withConfig({
...
var HeaderButton = styled(function (props) {
  ...
  return css(["color:", ";background:", ";font-family:", ";font-weight:500;font-size:", ";border-radius:", "px;"], props.theme.colors.brand.secondary, props.theme.colors.bg.secondary, props.theme.fontByName['Inter'], props.theme.fontSizes[2], props.theme.containers.innerBorderRadius);
}, function (props) {
  return rgba(props.theme.colors.brand.secondary, 0.1);
}, function (props) {
  return props.theme.colors.brand.secondary;
});
var OptionButton = styled(styled.button.withConfig({
  ...
  return rgba(props.theme.colors.text.primary, 0.8);
}, function (props) {
  return props.theme.colors.bg.secondary;
}, function (props) {
  return props.theme.fontByName['Inter'];
}, function (props) {
  return rgba(props.theme.colors.text.primary, 0.5);
}, function (props) {
  return props.theme.colors.text.primary;
}, function (p) {
  return p.selected ? css(["border:1px solid ", ";"], function (props) {
    return rgba(props.theme.colors.text.primary, 0.5);
  }) : css([":hover{border:1px solid ", ";color:", ";}"], function (props) {
    return props.theme.colors.ui.input.borderHover;
  }, function (props) {
    return props.theme.colors.text.primary;
  });
}, function (p) {
  return p.disabled && css(["color:", ";border:1px solid ", ";font-weight:600;pointer-events:none;"], function (props) {
    return rgba(props.theme.colors.text.primary, 0.3);
  }, function (props) {
    return rgba(props.theme.colors.text.primary, 0.06);
  });
})).withConfig({
  displayName: "ListHeaderstyles__OptionButton",
...
var Header = function Header(props) {
  var title = props.title,
      ...
      children = props.children,
      onBack = props.onBack;
  var isCustomTitle = /*#__PURE__*/isValidElement(title);
  return /*#__PURE__*/React__default.createElement(Styled.ListHeaderStyle, null, /*#__PURE__*/React__default.createElement(Flex, {
    width: "100%",
    flexDirection: "row",
    ...
    fontWeight: 500,
    onClick: onBack
  }, subtitle.text), isCustomTitle ? title : /*#__PURE__*/React__default.createElement(Text, {
    variant: "h4",
    fontWeight: 600
...
var ListHeader = function ListHeader(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Header, {
    ...
    return /*#__PURE__*/React__default.createElement(Styled.OptionButton, {
      key: option.value,
      onClick: function onClick() {
...
var useContextMenu = function useContextMenu(containerId, ref, menuRef) {
  ...
  var handleClickOutside = function handleClickOutside(event) {
    var domNode = ReactDOM.findDOMNode(menuRef.current);
...
var ContextMenuStyles = styled(styled.ul.withConfig({
...
// TODO make variants
var MenuItemStyle = styled(styled.li.withConfig({
  ...
  return !props.disabled && css(["&:hover{transition:", ";background:", ";color:", ";}"], props.theme.transition, props.highlightType === 'brand' && props.theme.colors.brand.primary, props.intent ? props.intent === 'primary' && props.theme.colors.brand.primary || props.theme.colors.ui.intent[props.intent] : props.theme.colors.text.secondary);
}, function (props) {
  return props.highlightType === 'neutral' && !props.disabled && css(["&:not(disabled):hover{transition:", ";background:", ";color:", ";}"], props.theme.transition, props.theme.colors.highlights.bgHighlight, props.theme.colors.text.secondary);
}, function (props) {
  return props.selected && css(["-webkit-text-fill-color:currentColor;color:", ";cursor:default;background:transparent;"], function (props) {
    return props.theme.colors.brand.primary;
  });
}, selectableFocus, function (props) {
  return props.disabled && css(["-webkit-text-fill-color:currentColor;color:", ";border-color:", ";opacity:0.7;cursor:default;&:focus{outline:none;border-color:transparent;}background:transparent;"], function (props) {
    return props.theme.colors.text.disabled;
  }, function (props) {
    return props.theme.colors.ui.disabled;
  });
...
var ChildrenBox = styled(styled.div.withConfig({
...
var MenuItem = function MenuItem(props) {
  ...
  return /*#__PURE__*/React.createElement(MenuItemStyle, {
    tabIndex: tabIndex,
    style: style,
    flex: 1,
    highlightType: type,
    ...
    color: "inherit",
    mr: 2
  }, icon), label, children && /*#__PURE__*/React.createElement(ChildrenBox, {
...
var ContextMenu = function ContextMenu(props) {
  ...
  var contextMenuRef = React__default.useRef();
  ...
  var sectionsArray = menu.reduce(function (arr, obj, index) {
    if (!index || arr[arr.length - 1][0].section !== obj.section) {
      return arr.concat([[/*#__PURE__*/React__default.createElement(MenuItem, _extends({
        type: menuItemtype,
        key: index
      }, obj))]]);
    }

    arr[arr.length - 1].push( /*#__PURE__*/React__default.createElement(MenuItem, _extends({
      type: menuItemtype,
      key: index
    }, obj)));
    return arr;
  ...
  return /*#__PURE__*/React__default.createElement(ContextMenuStyles, {
    ...
    var divider = /*#__PURE__*/React__default.createElement("hr", null);
...
var MenuWrapper = styled(styled.div.withConfig({
...
var Menu = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Menu(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClickOutside", function (event) {
      ...
      var domNode = ReactDOM.findDOMNode(_this.menuRef.current);
      ...
      if (!domNode || !domNode.contains(event.target)) {
        ...
        var clickedNode = ReactDOM.findDOMNode(event.target);
  ...
  _createClass(Menu, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          id = _this$props2.id;
      return /*#__PURE__*/React__default.createElement(MenuWrapper, {
        id: id,
...
var useMenu = function useMenu(ref, config) {
  ...
  var handleMenu = useCallback(function (event) {
...
var Bottom = styled.div.withConfig({
  displayName: "Pagestyles__Bottom",
  componentId: "sc-mvxyx7-1"
})(["position:relative;bottom:0;right:0;left:0;", " ", " ", ""], function (props) {
  return props.size ? css(["height:", "px;flex-basis:", "px;flex-grow:0;flex-shrink:0;"], props.size, props.size) : css(["height:initial;"]);
}, function (props) {
  return props.centerVertical && css(["display:flex;flex-direction:row;align-content:center;"]);
}, function (props) {
  return props.spacing && css(["padding:", "px ", "px ", "px ", "px;gap:", "px;"], props.spacing, props.spacing, props.spacing, props.spacing, props.spacing);
});
...
var Fill = styled.div.withConfig({
  ...
  return props.row ? css(["display:flex;gap:8px;"]) : css(["display:flex;flex-direction:column;"]);
});
var PageStyle = styled(Fill).withConfig({
  displayName: "Pagestyles__PageStyle",
  componentId: "sc-mvxyx7-6"
})(["display:flex;flex-direction:row;", ""], function (props) {
  return props.margin ? css(["margin:0 ", "px ", "px ", "px;width:calc(100% - (", "px * 2));gap:", "px;"], props.margin, props.margin, props.margin, props.margin, props.margin / 2) : css(["height:inherit;width:100%;"]);
});
var RightPaneStyle = styled(Right).withConfig({
  ...
  return props.margin && css(["margin:", "px ", "px ", "px 0px;height:calc(100% - (", "px * 2));width:", "px;"], props.margin, props.margin, props.margin, props.margin, props.size);
}, function (props) {
...
var SidebarStyle = styled(Left).withConfig({
  displayName: "Pagestyles__SidebarStyle",
  componentId: "sc-mvxyx7-8"
})(["", " background:", ";border:1px solid ", ";transition:0.2s ease;border-radius:", "px;color:", ";box-sizing:border-box;"], function (props) {
  return props.margin && css(["margin:", "px 0px ", "px ", "px;height:calc(100% - (", "px * 2));width:", "px;"], props.margin, props.margin, props.margin, props.margin, props.size);
}, function (props) {
  return props.noCard ? 'transparent' : props.theme.colors.bg.secondary;
}, function (props) {
  return props.noBorder ? 'transparent' : props.theme.colors.ui.input.borderColor;
...
var PaneStyle = styled(Fill).withConfig({
  ...
  return props.margin && css(["margin:", "px ", "px ", "px ", "px;height:calc(100% - (", "px * 2));width:calc(100% - (", "px * 2));"], props.margin, props.margin, props.margin, props.margin, props.margin, props.margin);
}, function (props) {
  return props.noBorder ? 'transparent' : props.theme.colors.ui.input.borderColor;
}, function (props) {
  return props.theme.containers.outerBorderRadius;
...
var Page = function Page(props) {
  ...
  switch (type) {
    case 'full':
      pageInner = /*#__PURE__*/React.createElement(FullPage, props);
      break;

    case 'sidebar':
      pageInner = /*#__PURE__*/React.createElement(Sidebar, props);
      break;

    case 'centered':
      pageInner = /*#__PURE__*/React.createElement(CenteredPane, props);
      break;
  }

  return /*#__PURE__*/React.createElement(PageStyle, {
    margin: spacing
  }, pageInner, props.rightPane && /*#__PURE__*/React.createElement(RightPaneStyle, {
    size: 300
  }, props.rightPane));
};

var FullPage = function FullPage(props) {
  return /*#__PURE__*/React.createElement(PaneStyle, {
...
var Sidebar = function Sidebar(props) {
  return /*#__PURE__*/React.createElement(Fill, {
    ...
    size: 300
  }, props.sidebar), /*#__PURE__*/React.createElement(PaneStyle, null, props.children));
};

var CenteredPane = function CenteredPane(props) {
  return /*#__PURE__*/React.createElement(Fill, {
    style: props.style
  }, /*#__PURE__*/React.createElement(PaneStyle, {
    noBorder: !props.bordered,
    noCard: props.noCard,
    style: {
      margin: '0 auto',
...
var PageTop = function PageTop(props) {
  return /*#__PURE__*/React.createElement(Top, {
    centerVertical: true,
    size: 32
  }, props.children);
};
...
var PageViewPort = function PageViewPort(props) {
  return /*#__PURE__*/React.createElement(ViewPort, null, props.children);
};
...
var PaneHeaderText = styled.div.withConfig({
  ...
  return props.padding && css(["padding:", "px ", "px ", "px ", "px;gap:", "px;"], props.padding, props.padding, props.padding, props.padding, props.padding);
});
var PaneHeaderStyle = styled.div.withConfig({
  ...
  return props.padding && css(["padding-left:", "px;padding-right:", "px;gap:", "px;"], props.padding, props.padding, props.padding);
}, function (props) {
  return props.paneHeight ? css(["height:", "px;"], props.paneHeight) : css(["height:initial;"]);
});
...
var PaneHeader = function PaneHeader(props) {
  var height = props.height,
      ...
      children = props.children;
  return /*#__PURE__*/React.createElement(PaneHeaderStyle, {
...
var KPILabel = styled(styled.div.withConfig({
...
var KPIValue = styled(styled.div.withConfig({
...
var KPIIcon = styled(styled.div.withConfig({
...
var KPI = function KPI(props) {
  var inline = props.inline,
      ...
      value = props.value,
      icon = props.icon;
  return /*#__PURE__*/React__default.createElement(Flex, _extends({}, props, {
    flexDirection: inline ? 'row' : 'column',
    alignItems: inline ? 'center' : 'flex-start',
    gap: 4,
    justifyContent: "space-between"
  }), label && /*#__PURE__*/React__default.createElement(KPILabel, {
    mb: inline ? 0 : '4px',
    mr: inline ? '4px' : 0
  }, label), /*#__PURE__*/React__default.createElement(Flex, {
    margin: true,
    flexDirection: "row",
    alignItems: "center"
  }, icon && /*#__PURE__*/React__default.createElement(KPIIcon, null, icon), /*#__PURE__*/React__default.createElement(KPIValue, null, value)));
};

var TagStyle = styled(styled.div.withConfig({
  ...
  return props.minimal ? css(["background:", ";color:", ";"], function (props) {
    return props.custom ? rgba(props.custom, 0.2) : rgba(props.theme.colors.ui.intent[props.intent], 0.2);
  }, function (props) {
    return props.custom ? props.custom : props.theme.colors.ui.intent[props.intent];
  }) : css(["background:", ";color:", ";"], function (props) {
...
var TagIcon = styled(styled.div.withConfig({
  ...
  return props.minimal ? css(["fill::", ";"], function (props) {
    return props.theme.colors.ui.intent[props.intent];
  }) : css(["fill::", ";"], function (props) {
    return props.theme.colors.text.white;
  });
})).withConfig({
  displayName: "Tagstyles__TagIcon",
...
var Tag = function Tag(props) {
  var label = props.label,
      ...
      custom = props.custom;
  return /*#__PURE__*/React.createElement(TagStyle, {
    intent: intent,
    minimal: minimal,
    custom: custom,
    rounded: rounded
  }, icon && /*#__PURE__*/React.createElement(TagIcon, null, icon), label, removable && /*#__PURE__*/React.createElement(Flex, {
    inline: true,
    ml: 2,
    style: {
      cursor: 'pointer'
...
var AppButtonStyle = styled(styled.div.withConfig({
  ...
  return !p.expanded && css(["height:calc(100% - 6px);width:calc(100% - 6px);"]);
}, function (p) {
  return p.selected ? p.theme.colors.brand.primary : p.theme.colors.icon.app;
}, function (props) {
  return props.disabled && css(["opacity:0.5;pointer-events:none;"]);
}, function (props) {
  return props.theme.colors.highlights.bgHighlight;
})).withConfig({
  displayName: "AppButtonstyles__AppButtonStyle",
...
var AppText$1 = styled(styled.div.withConfig({
...
var AppButton = function AppButton(props) {
  ...
  var button = /*#__PURE__*/React__default.createElement(AppButtonStyle, {
    id: id,
    ref: buttonRef,
    expanded: expanded,
    disabled: disabled,
    selected: selected,
    onClick: onAppClick
  }, icon, expanded && name && /*#__PURE__*/React__default.createElement(AppText$1, null, name));
...
var AppNameDiv = styled(styled.div.withConfig({
  ...
  return props.appColor && css(["svg{fill:", ";}"], props.appColor);
})).withConfig({
  displayName: "AppNamestyles__AppNameDiv",
  componentId: "sc-11iruz-0"
})(compose(space$1, layout, flexbox, border, position, color));
var AppText = styled(styled.div.withConfig({
...
var AppName = function AppName(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Flex, {
    ...
    alignItems: "center",
    justifyContent: "space-between"
  }, /*#__PURE__*/React__default.createElement(AppNameDiv, {
    appColor: appColor
  }, /*#__PURE__*/React__default.createElement(Box, null, appIcon), /*#__PURE__*/React__default.createElement(AppText, null, appName)), /*#__PURE__*/React__default.createElement(IconButton, {
    size: 24,
    onClick: onSettingsClick
  }, /*#__PURE__*/React__default.createElement(Icons.More, null)));
};
...
var AppNavContainer = styled(styled.div.withConfig({
...
var Container = styled(styled.div.withConfig({
  ...
  return props.selected ? rgba(props.appColor, 0.1) : 'transparent';
}, function (props) {
  return props.theme.transition;
}, function (props) {
  return props.selected ? rgba(props.appColor, 0.15) : props.theme.colors.highlights.bgHighlight;
})).withConfig({
  displayName: "AppNavRow__Container",
...
var AppNav = function AppNav(props) {
  ...
  return /*#__PURE__*/React__default.createElement(AppNavContainer, {
    style: style
  }, /*#__PURE__*/React__default.createElement(AppName, {
    style: {
      marginBottom: 8
    },
    appColor: appColor,
    ...
    return /*#__PURE__*/React__default.createElement(AppNavRow, {
      key: route.uri,
      appColor: appColor,
      navIcon: route.icon,
...
var CrumbContainer = styled(styled.div.withConfig({
  ...
  return props.isLink && css(["&:hover{cursor:pointer;text-decoration:underline;text-decoration-color:", ";}"], function (props) {
    return props.theme.colors.text.disabled;
  });
})).withConfig({
  displayName: "AppSubHeader__CrumbContainer",
...
var Crumb = function Crumb(props) {
  return /*#__PURE__*/React__default.createElement(CrumbContainer, {
    isLink: props.uri,
    style: {
      gap: props.title ? 4 : 2
    },
  ...
  }, props.icon && /*#__PURE__*/React__default.createElement(SVG // verticalAlign="middle"
  , {
...
var SVG = styled(styled.div.withConfig({
  displayName: "SVG",
...
var DialogOverlay = styled(styled.div.withConfig({
...
var DialogWrapper = styled(styled.div.withConfig({
...
var DialogHeader = styled(styled.div.withConfig({
  ...
  return props.variant === 'bordered' ? css(["border-bottom:1px solid ", ";-webkit-box-shadow:0 1px 0 rgb(16 22 26 / 2%);box-shadow:0 1px 0 rgb(16 22 26 / 2%);"], function (props) {
    return props.theme.colors.ui.input.borderColor;
  }) : css(["border-bottom:none;padding-bottom:0px;"]);
})).withConfig({
  displayName: "Dialogstyles__DialogHeader",
  componentId: "sc-14iegpd-4"
})(compose(space$1, layout, flexbox, border, position, color));
var DialogContainer = styled(styled.div.withConfig({
...
var DialogBody = styled(styled.div.withConfig({
...
var DialogFooter = styled(styled.div.withConfig({
...
var DialogFooterButtons = styled(styled.div.withConfig({
...
var Dialog = function Dialog(_ref) {
  ...
  return isShowing ? /*#__PURE__*/ReactDOM.createPortal( /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(DialogOverlay, {
    backdropOpacity: backdropOpacity
  }), /*#__PURE__*/React__default.createElement(DialogWrapper, {
    "aria-modal": true,
    "aria-hidden": true,
    tabIndex: -1,
    role: "dialog",
    onClick: closeOnBackdropClick ? onHide : null
  }, /*#__PURE__*/React__default.createElement(DialogContainer, {
    variant: variant
  ...
  }, title && /*#__PURE__*/React__default.createElement(DialogHeader, {
    variant: variant
  }, /*#__PURE__*/React__default.createElement(Box, {
    alignItems: "center"
    ...
    fontSize: "16px",
    fontWeight: "bold"
  }, title)), hasCloseButton && /*#__PURE__*/React__default.createElement(IconButton, {
    "data-dismiss": "modal",
    "aria-label": "Close",
    tabIndex: -1,
    onClick: onHide
    ...
    size: "20px"
  }))), /*#__PURE__*/React__default.createElement(DialogBody, {
    variant: variant,
    hasHeader: title
  }, children), (primaryButton || secondaryButton) && /*#__PURE__*/React__default.createElement(DialogFooter, null, /*#__PURE__*/React__default.createElement(DialogFooterButtons, null, secondaryButton, primaryButton)))))), document.body) : null;
};
Dialog.defaultProps = {
  backdropOpacity: 0.2,
  variant: 'bordered',
...
var BreadcrumbNavStyle = styled.div.withConfig({
...
var BreadcrumbNav = function BreadcrumbNav(props) {
  var crumbs = props.crumbs,
      onBack = props.onBack;
  return /*#__PURE__*/React__default.createElement(BreadcrumbNavStyle, null, /*#__PURE__*/React__default.createElement(IconButton, {
    tabIndex: -1,
    mr: 3,
    onClick: function onClick() {
      return onBack && onBack();
    }
  }, /*#__PURE__*/React__default.createElement(Icons.ArrowLeft, null)), crumbs.map(function (crumb, index) {
    var divider = [];
    var isLast = index === crumbs.length - 1;

    if (!isLast) {
      divider = /*#__PURE__*/React__default.createElement(Text, {
        style: {
          opacity: 0.6
        },
        variant: "body",
...
var AppDockStyle = styled(styled.div.withConfig({
  ...
  return rgba(props.baseColor || props.theme.colors.os.base, 0.08);
}, function (props) {
  return props.baseColor || rgba(props.theme.colors.os.base, 0.6);
})).withConfig({
  displayName: "AppDockstyles__AppDockStyle",
  componentId: "sc-12j3vgi-0"
})(compose(space$1, layout, flexbox, border, position, color));
var DockDivider = styled(styled.div.withConfig({
  ...
  return rgba(props.theme.colors.os.base, 0.12);
})).withConfig({
  displayName: "AppDockstyles__DockDivider",
  componentId: "sc-12j3vgi-2"
})(compose(space$1, layout, flexbox, border, position, color));

var TrayButtonStyle = styled(styled.button.withConfig({
  ...
  return props.noRestingBg ? 'transparent' : rgba(props.baseColor || props.theme.colors.os.base, props.transparency || 0.08);
}, function (props) {
  return props.baseColor || rgba(props.theme.colors.os.base, 0.6);
}, function (props) {
  return rgba(props.baseColor || props.theme.colors.os.base, props.transparency + 0.04 || 0.12);
}, function (props) {
...
var AppDock = function AppDock(props) {
  var selectedApp = props.selectedApp,
      apps = props.apps;
  return /*#__PURE__*/React__default.createElement(AppDockStyle, null, /*#__PURE__*/React__default.createElement(TrayButtonStyle, {
    circular: true,
    noRestingBg: true,
    paddingLeft: "4px",
    paddingRight: "4px"
  }, /*#__PURE__*/React__default.createElement(Icons.Apps2, null)), /*#__PURE__*/React__default.createElement(DockDivider, null), /*#__PURE__*/React__default.createElement(Flex, {
    style: {
      gap: '6px'
    },
    alignItems: "center"
  }, apps.map(function (app) {
    return /*#__PURE__*/React__default.createElement(DockButton, {
      key: app.name,
      app: app,
...
var DockButton = function DockButton(props) {
  ...
  return /*#__PURE__*/React__default.createElement(TrayButtonStyle, {
...
var AppWindowStyle = styled(Flex).withConfig({
...
var AppWindowTitleStyle = styled(styled.div.withConfig({
  ...
  return props.clickable && css(["cursor:pointer;padding:8px 12px 8px 8px;&:hover{background:", ";border-radius:", "px;}"], function (props) {
    return props.theme.colors.highlights.bgHighlight;
  }, function (props) {
    return props.theme.containers.outerBorderRadius;
  });
...
var AppWindowTitleBar = styled(styled.div.withConfig({
...
var Context = function Context(props) {
  ...
  var button = useMemo(function () {
    ...
    if (selectedContext) {
      switch (selectedContext.type) {
        case 'ship':
          avatar = /*#__PURE__*/React__default.createElement(Sigil, {
        ...
        case 'group':
          avatar = selectedContext.meta.picture ? /*#__PURE__*/React__default.createElement("img", {
            style: {
              borderRadius: 2
            },
            height: "16px",
    ...
    return /*#__PURE__*/React__default.createElement(TrayButtonStyle // ref={contextButtonRef}
    , {
      onClick: function onClick(evt) {
        // evt.stopPropagation();
      ...
      paddingLeft: "4px"
    }, avatar, /*#__PURE__*/React__default.createElement(Text, {
      style: {
        pointerEvents: 'none'
      },
      ml: "8px",
      variant: 'inherit'
    }, !selectedContext ? 'No context selected' : contextLabel, /*#__PURE__*/React__default.createElement(Icons.ExpandMore, {
      ml: "6px"
    })));
  ...
  var menu = useMemo(function () {
    return /*#__PURE__*/React__default.createElement(Menu, {
      ...
      return /*#__PURE__*/React__default.createElement(MenuItem, {
      ...
      }, context.type === 'ship' ? /*#__PURE__*/React__default.createElement(Flex, {
        alignItems: "center"
      }, /*#__PURE__*/React__default.createElement(Sigil, {
        patp: context.name,
        ...
        ml: "8px",
        variant: "inherit"
      }, context.meta.nickname || context.name)) : /*#__PURE__*/React__default.createElement(Flex, {
        style: {
          width: '100%',
          flex: 1
        }
...
var SubRouteStyle = styled(styled.button.withConfig({
  ...
  return props.isSelected ? darken(0.05, props.theme.colors.ui.tertiary) : 'transparent';
}, function (props) {
  return props.theme.transition;
}, function (props) {
...
})({}, compose(space$1, layout, typography));
var SubRouteNav = function SubRouteNav(props) {
  ...
  return (
    /*#__PURE__*/
    // @ts-ignore
    React__default.createElement(SubRouteStyle, {
      tabIndex: 0,
      isSelected: selected,
      color: color,
      onClick: onClick
...
var SubRouteWrapperStyle = styled(styled.div.withConfig({
  displayName: "SubRouteNav__SubRouteWrapperStyle",
  componentId: "sc-1gqwlgo-3"
})(["", ""], function (props) {
  return props.isMobile && css(["flex-direction:column;position:absolute;right:12px;top:10px;", "{height:36px;margin-right:8px;font-size:15px;}"], SubRouteStyle);
})).withConfig({
  displayName: "SubRouteNav__SubRouteWrapperStyle",
...
var SubRouteWrapper = function SubRouteWrapper(props) {
  ...
  if (isMobile) {
    return /*#__PURE__*/React__default.createElement(SubRouteWrapperStyle, {
      isMobile: isMobile
    }, /*#__PURE__*/React__default.createElement(IconButton, {
      style: {
        outline: 'none'
    ...
    }, /*#__PURE__*/React__default.createElement(Icons.Apps, null)), /*#__PURE__*/React__default.createElement(Menu, {
      isOpen: isNavOpen,
      style: {
        zIndex: 6,
        paddingTop: 8,
...
var AppWindow = function AppWindow(props) {
  var app = props.app,
      ...
      children = props.children;
  var ContextDropdown = useMemo(function () {
  ...
  return /*#__PURE__*/React__default.createElement(AppWindowStyle, {
    isStandalone: isStandalone
  }, /*#__PURE__*/React__default.createElement(Flex, null, /*#__PURE__*/React__default.createElement(AppWindowTitleBar, {
    style: style
  }, /*#__PURE__*/React__default.createElement(Box, {
    alignItems: "center"
  }, !isMobile && /*#__PURE__*/React__default.createElement(AppWindowTitleStyle, {
  ...
  }, app.icon), /*#__PURE__*/React__default.createElement(Box, null, app.name)), ContextDropdown, /*#__PURE__*/React__default.createElement(SubRouteWrapper, {
    isMobile: isMobile
  }, subRoutes.map(function (subroute) {
    return /*#__PURE__*/React__default.createElement(SubRouteNav, {
      key: subroute.uri,
      name: subroute.name,
      path: subroute.uri,
      color: app.color,
...
var Network = function Network(props) {
  ...
  if (selectedNetwork) {
    switch (selectedNetwork.blockchain) {
      case 'Ethereum':
        icon = /*#__PURE__*/React__default.createElement(Icons.Ethereum, {
          height: "16px",
          width: "16px"
        });
      ...
      case 'Uqbar':
        icon = /*#__PURE__*/React__default.createElement(Icons.Uqbar, {
          height: "16px",
          width: "16px"
        });
  ...
  return /*#__PURE__*/React__default.createElement(TrayButtonStyle, {
    ...
    ml: "8px"
  }, networkLabel), /*#__PURE__*/React__default.createElement(NetworkStatus, {
...
var NetworkStatus = styled.div.withConfig({
...
var Voice = function Voice(props) {
  ...
  }, muted ? /*#__PURE__*/React__default.createElement(Icons.MicOff, {
    width: "18px",
    height: "18px"
  }) : /*#__PURE__*/React__default.createElement(Icons.MicOn, {
    width: "18px",
    height: "18px"
...
var UserTray = function UserTray(props) {
  ...
  }, /*#__PURE__*/React__default.createElement(Voice, voice), /*#__PURE__*/React__default.createElement(TrayButtonStyle, {
    paddingLeft: "4px",
    paddingRight: "4px"
  }, /*#__PURE__*/React__default.createElement(Icons.Wallet, {
    width: "18px",
    height: "18px"
  })), /*#__PURE__*/React__default.createElement(TrayButtonStyle, {
    paddingLeft: "4px",
    paddingRight: "4px"
  }, /*#__PURE__*/React__default.createElement(Icons.DMs, {
    width: "18px",
    height: "18px"
  })), ship && /*#__PURE__*/React__default.createElement(Sigil, {
    patp: ship.patp,
    clickable: true,
    size: 26,
...
var SystemBar = function SystemBar(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    justifyContent: "center",
    alignItems: "center"
  }, /*#__PURE__*/React.createElement(AppDock, {
    ...
    justifyContent: "flex-end",
    ml: 12
  }, /*#__PURE__*/React.createElement(UserTray, {
    ship: ship,
    voice: voice,
    wallet: {
      address: ''
...
var OSViewPort = styled(styled.div.withConfig({
  ...
  return props.blur && css(["filter:blur(2px);transition:filter ", ";"], props.theme.transition);
}, function (props) {
...
export { AppButton, AppDock, AppName, AppNav, AppSubHeader, AppWindow, AppWindowTitleBar, Bottom, Box, BreadcrumbNav, BreadcrumbNavStyle, Button, Card, CardInner, CenteredPane, Checkbox, ColorLine, Context, ContextMenu, CrumbContainer, DateSingleInput, DateTimeInput, Dialog, DockButton, Fill, Flex, FormControl, FullPage, GenericRow, Grid, Grid2, Group, HTMLSelect, Header, IconButton, Icons, InlineEdit, Input, KPI, Label, Left, ListHeader, Menu, MenuItem, Network, NetworkStatus, Notification, OSViewPort, Page, PageStyle, PageTop, PageViewPort, PaneHeader, PaneHeaderText, PaneStyle, Radio, Right, SVG, Search, Select, Ship, Sidebar, Sigil, Skeleton, Spinner, StyledText, SystemBar, Tab, Tag, Text, TextArea, TextButton, SvgVisibilityOff as TlonIcon, Tooltip, TooltipStyle, TooltipWrapper, Top, TrayButtonStyle, UserTray, ViewPort, VirtualizedList, Voice, breakpoints, breakpointsPx, calculateAnchorPoint, containers, elevations, fontByName, fontSizes, fontWeights, fonts, input, letterSpacings, lineHeights, sizes, space, theme, transition, transitionFast, useDialog, useMenu, useWindowDimensions };
